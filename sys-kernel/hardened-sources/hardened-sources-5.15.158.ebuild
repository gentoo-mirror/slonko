...
detect_arch
SUBREL="hardened1"
HARDENED_URI="https://github.com/anthraxx/linux-hardened/releases/download/${PV%.0}-${SUBREL}/linux-hardened-${PV%.0}-${SUBREL}.patch"
...
IUSE="experimental"
UNIPATCH_LIST="${FILESDIR}/9999_revert-conflicts-v1.patch ${DISTDIR}/linux-hardened-${PV%.0}-${SUBREL}.patch ${FILESDIR}/linux-hardened-gentoo-v1.patch"
